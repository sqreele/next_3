...
export default function ClientDashboard() {
  ...
  return (
    <div className="space-y-4 p-4 sm:p-0">
      <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 truncate">Welcome</h1>
      <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">Positions: -</p>
