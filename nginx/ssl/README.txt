Cloudflare Origin Certificate setup for pmcs.site
...
- origin.crt
  ...
  Select RSA 2048, hostnames: pmcs.site, www.pmcs.site. Validity any.
...
Verify:
  - openssl s_client -connect pmcs.site:443 -servername pmcs.site -showcerts | tail -n 20
  - curl -Ik https://pmcs.site
